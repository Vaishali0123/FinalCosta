...
// //       </div>
// //       {/* View More Button */}
// //       <div className="mt-15 pn:max-sm:mt-20 text-center">
// //         <button
// //           onClick={() => {
  ...
  return (
    <div className="flex flex-col items-center  px-6 py-16 font-sans">
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-center justify-center w-full">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-8">
          {/* Card 1 */}
          <div className="flex flex-col lg:flex-row bg-gray-50 dark:bg-[#171717] rounded-3xl overflow-hidden hover:scale-105 duration-150 w-full lg:h-[260px]">
            {/* Image */}
            <div className="w-full lg:w-[40%] h-[200px] lg:h-full">
              <img
                src={displayData?.[1]?.featuredImage?.node?.sourceUrl}
