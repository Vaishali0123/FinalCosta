          ...
          <div className="rounded-2xl flex justify-start p-4 sm:p-6 lg:p-8 relative">
            ...
            <div className="flex flex-col lg:flex-row gap-8 z-10 w-full lg:h-[520px]">
              ...
              >
                ...
                <div
                  className="text-gray-600 text-sm dark:text-gray-100 leading-relaxed overflow-hidden line-clamp-6"
              ...
              {/* Blog list */}
              <div className="flex-1 overflow-y-auto pn:max-lg:overflow-y-scroll pn:max-lg:max-h-[190px] pr-2 custom-scrollbar lg:max-h-[520px]">
                    ...
                    <div
                      ...
                      className={`p-4 cursor-pointer transition-all duration-200 ${
                        blog?.id === activeBlog?.id
                          ? " bg-orange-100/70 dark:bg-orange-500 border rounded-[15px] scale-95 pl-2 border-orange-300"
                          : "hover:bg-gray-200 hover:rounded-[15px] hover:dark:bg-white/20 border-b rounded-[4px] border-gray-200/60"
                      }`}
